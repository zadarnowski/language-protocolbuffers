Protocol Buffers Descriptor Library - Annotations
=================================================

    Copyright © 2014 Patryk Zadarnowski «pat@jantar.org».
    All rights reserved.

Annotations expand the context of a protocol buffer entity with an additional
list of contexts for the entity's various constituents, identified by index
paths as described in descriptor.proto.

> module Language.ProtocolBuffers.Annotations (
>   HasAnnotations (..),
