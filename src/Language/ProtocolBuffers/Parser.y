...
Happy parser for .proto files, with minor generalisations. The output is a raw
parse tree data structure defined in the "ParseTree" module.

-}

module Language.ProtocolBuffers.Parser (
    Error, Grammar, parseWith, fileDescriptorGrammar
) where
...
import Language.ProtocolBuffers.Syntax
